#source: https://github.com/hungchun-lin/Stock-price-prediction-using-GAN/blob/master/Code/1.%20Load_data.py
...
# data imports
df = pd.read_csv('./src/data/DATA.csv', parse_dates=['Date'])
print(df.head())
print(df.tail())
print(df.shape)
print(df.columns)
